...
df_1 = pd.read_csv('data/Madrid 2016-01-01 to 2018-06-30.csv')
df_2 = pd.read_csv('data/Madrid 2018-07-01 to 2020-12-31.csv')
df_3 = pd.read_csv('data/Madrid 2021-01-01 to 2023-04-25.csv')
...
# Creating numerical 0/1 columns for string categorical columns
print("Data types of the columns:")
print(df.dtypes)
print("Unique values of the icon column:")
print(df['icon'].unique())
df = pd.get_dummies(df, columns=['icon'], dtype=np.int8)
print("The newly created columns for icon:")
print(df[['icon_clear-day', 'icon_cloudy', 'icon_partly-cloudy-day', 'icon_rain', 'icon_snow']].head(), end='\n\n')
...
score = accuracy_score(y_test, y_pred)
print("Prediction score for test data: {}".format(score), end='\n\n')


print("***** Decision Tree (using GridSearchCV to find optimal params) *****")
